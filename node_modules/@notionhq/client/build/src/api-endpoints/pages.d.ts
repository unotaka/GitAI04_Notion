...
export declare const createPage: {
    ...
    readonly bodyParams: readonly ["parent", "properties", "icon", "cover", "content", "children", "markdown", "allow_async", "template", "position"];
...
export declare const updatePageMarkdown: {
    ...
    readonly pathParams: readonly ["page_id"];
    readonly queryParams: readonly [];
    readonly bodyParams: readonly ["allow_async", "type", "insert_content", "replace_content_range", "update_content", "replace_content"];
